      ...
      <div className={`flex-1 ${sidebarOpen ? 'ml-64' : 'ml-20'} transition-all duration-300`}>
        ...
        <main className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div className="bg-white rounded-lg shadow-sm p-6 border-b-4 border-green-500 hover:shadow-md transition-shadow">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-b-4 border-blue-500 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-gray-500 text-sm font-medium">Active Rewards</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-b-4 border-amber-500 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-gray-500 text-sm font-medium">Redemptions (Month)</p>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border-b-4 border-purple-500 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div>
